const com_vm = new Vue({
    ...
    data: {
      ...
      methods: {
          createComment() {          
            const url = "http://witty-kusu-4276.hippy.jp/2023Dev3Early/back/src/commentCreate.php";
            ...
            axios.post(url, data)
              .then(response => {
                ...
                window.location.assign("http://witty-kusu-4276.hippy.jp/2023Dev3Early//front/src/threadMain.php?thread_id="+this.getQueryParam("thread_id")); 
              })
              .catch(error => {
                // エラーハンドリングのコード
                console.error(error);
          ...
          setUserName(){
            const url = "http://witty-kusu-4276.hippy.jp/2023Dev3Early/back/src/getSession.php";
